...
import { BsCheck, BsFillCaretLeftSquareFill } from 'react-icons/bs'
...
const ThemeSetting = () => {
  ...
  return (
    ...
    <div className='flex-col border-t-1 border-color p-4 ml-4'>
      ...
      <div className='flex gap-3'>{themeColors.map((item,index)=>(<TooltipComponent key={index} content={item.name} position='TopCenter'>
